        ...
        <div data-active-color="white" data-background-color="man-of-steel" data-image="{{ asset('app-assets/img/sidebar-bg/01.jpg') }}" class="app-sidebar">
            ...
            <div class="sidebar-header">
                <div class="logo clearfix"><a href="{{ route('admin.dashboard') }}" class="logo-text float-left tex-normal">
                        <div class="logo-img"><img src="{{ asset('common/logo/cpbit.png') }}" class="rotate logoImg" /></div><span class="text align-middle h5">CPFFF</span>
                    </a>
            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.product.index') }}"><i class="fa ft-layers text-info"></i><span data-i18n="" class="menu-title">All Products</span></a>
                        </li> 
                        <li class="nav-item">
                            <a href="{{ route('admin.order.index') }}"><i class="fa ft-shopping-cart text-danger"></i><span data-i18n="" class="menu-title">All Orders</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.slider.index') }}"><i class="fa ft-upload text-warning"></i><span data-i18n="" class="menu-title">Upload Slider</span></a>
                        </li>
                        <li class="has-sub">
                            <a href="#"><i class="fa fa-star text-primary" ></i><span > Category</span></a>
                            <ul class="menu-content">
                                <li class="nav-item">
                                     <a href="{{ route('admin.category.index') }}"><span data-i18n="" class="menu-title">Categories</span></a>
                                 </li>
                                  <li class="nav-item">
                                     <a href="{{ route('admin.subcategory.index') }}"><span data-i18n="" class="menu-title">SubCategories</span></a>
                                 </li>
                            </ul>
                        </li>
                        <li class="has-sub">
