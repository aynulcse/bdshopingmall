    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-header">
         <div class="row">
           <div class="col-md-6">
             <h4 class="">DISPLAY ALL SUBCATEGORY</h4>
           </div>
 ...
 <div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">SubCategory Insert</h5>
           ...
           <div class="row">
             <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="name" placeholder="Enter Product Title"
