    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-header">
         <div class="row">
           <div class="col-md-6">
             <h4 class="">DISPLAY ALL SLIDER</h4>
           </div>
          ...
          <input type="hidden" name="updateId" id="updateId">
           ...
           <div class="row">
                ...
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" class="form-control form-control-sm" name="title" placeholder="Enter Slider Title"
             ...
             <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="buttontext" class="form-control form-control-sm" id="buttontext"
                        placeholder="Enter Slider ButtonText" required="required">
             ...
             <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="buttonlink" class="form-control form-control-sm" id="buttonlink"
                        placeholder="Enter Slider ButtonLink " >
                    <span id="error_value"></span>
                </div>
             </div>          
            </div>
 ...
 id = $(this).attr('id');
  $.ajax({
   ...
   success:function(data){
    ...
    $('#buttonlink').val(data.buttonlink);
